...
/>
      ...
      {/* ── SECTION: SHOWCASE (รูปภาพระบบ และ Badge iOS / Android) ── */}
      <section className="relative z-10 py-16 bg-[#efe7d8]/20 border-y border-[#e2dfd5]/40 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* ข้อมูลคำอธิบายระบบ และดาวน์โหลด Badge */}
          <div className="lg:col-span-5 text-left space-y-6">

            <h2 className="text-3xl sm:text-4xl font-medium tracking-tight text-[#17221c] leading-tight">
              จัดการระบบทุกที่ <br />
              <span className="font-serif italic text-[#9a7257] font-normal">รองรับทุกสมาร์ทโฟนเต็มระบบ</span>
            </h2>
            
            <p className="text-sm sm:text-base text-[#6e746f] leading-relaxed font-sans">
              แพลตฟอร์ม **Pedebook** ถูกสร้างขึ้นด้วยสถาปัตยกรรม Responsive Web App ขั้นสูง เพื่อให้ผู้ใช้สามารถจัดการและอัปโหลดไฟล์ PDF ได้สะดวกรวดเร็วทั้งบนคอมพิวเตอร์และโทรศัพท์มือถือ โดยสามารถเปิดแชร์ลิงก์ให้ลูกค้าพลิกเปิดอ่านสมุดแค็ตตาล็อกได้ทันทีบน **iOS (iPhone, iPad)** และ **Android** โดยไม่ต้องเสียเวลาดาวน์โหลดแอปเพิ่ม!
            </p>

            <div className="pt-2 border-t border-[#e2dfd5]/60">
              <h4 className="text-xs font-bold text-[#17221c] mb-3 uppercase tracking-wider">แอปพลิเคชันระบบรองรับการใช้งาน:</h4>
              <div className="flex flex-wrap gap-3">
                {/* App Store Badge */}
                <a
                  href="#"
                  className="flex items-center gap-2.5 bg-black hover:bg-neutral-900 text-white rounded-xl px-4 py-2 w-44 shadow-md border border-neutral-800 transition active:scale-[0.97] cursor-pointer"
                >
                  <svg className="w-5.5 h-5.5 fill-white shrink-0" viewBox="0 0 24 24">
                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-1 .04-2.21.67-2.93 1.49-.62.69-1.16 1.84-1.01 2.96 1.12.09 2.27-.58 2.95-1.39z" />
                  </svg>
                  <div className="flex flex-col text-left">
                    <span className="text-[8px] uppercase tracking-wider text-neutral-400 font-sans leading-none">Download on the</span>
                    <span className="text-xs font-bold font-sans mt-0.5 leading-none">App Store</span>
                  </div>
                </a>
                ...
                >
                  <svg className="w-5.5 h-5.5 fill-white shrink-0" viewBox="0 0 24 24">
                    <path d="M5 3.013c-.152.012-.303.053-.437.135L13.568 12l-9.006 8.852c.18.11.396.16.612.148.243-.01.478-.106.666-.27l10.957-8.24L16.793 12l-.003-.004L5.67 3.284a1.03 1.03 0 00-.67-.271zM3 3.5v17c0 .26.11.51.3.69L12.5 12 3.3 3.31A.97.97 0 003 3.5zm15.116 8.083l3.22-2.42c.414-.31.664-.81.664-1.34s-.25-1.03-.664-1.34l-3.22-2.42-.007.005L16.29 12l1.82 8.077z" />
                  </svg>
                  <div className="flex flex-col text-left">
                    <span className="text-[8px] uppercase tracking-wider text-neutral-400 font-sans leading-none">GET IT ON</span>
                    <span className="text-xs font-bold font-sans mt-0.5 leading-none">Google Play</span>
                  </div>
                </a>
              </div>
            </div>
          ...
          {/* พรีวิวภาพถ่ายหน้าจอระบบในกรอบ Browser และ Phone Mockup สุดพรีเมียม */}
          <div className="lg:col-span-7 relative flex items-center justify-center">
            
            {/* Safari Mockup */}
            <div className="w-full bg-white/70 border border-[#e2dfd5] shadow-2xl rounded-2xl overflow-hidden backdrop-blur-md transition-all duration-500 hover:shadow-[-5px_25px_50px_rgba(36,49,41,0.15)]">
              <div className="bg-[#efe7d8]/40 border-b border-[#e2dfd5] px-4 py-2.5 flex items-center justify-between">
                <div className="flex gap-1.5 shrink-0">
                  <div className="w-3 h-3 rounded-full bg-red-400" />
                  <div className="w-3 h-3 rounded-full bg-yellow-400" />
                  <div className="w-3 h-3 rounded-full bg-green-400" />
                </div>
                <div className="bg-white/80 border border-[#e2dfd5]/80 rounded-md py-0.5 px-6 text-[10px] text-[#6e746f] w-3/5 text-center flex items-center justify-center gap-1 font-mono truncate">
                  <svg className="w-2.5 h-2.5 text-neutral-400 shrink-0" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                  </svg>
                  pedebook.com/dashboard
                </div>
                <div className="w-10" />
              </div>
              <div className="bg-neutral-50 relative aspect-[16/10] overflow-hidden">
                <img
                  ...
                  alt="Pedebook แผงควบคุมระบบอัจฉริยะ"
                  className="w-full h-full object-cover object-top select-none"
                />
              </div>
            </div>

            {/* Smart Phone iOS/Android Mockup Overlapping */}
            <div className="absolute -bottom-10 -right-4 w-44 aspect-[9/18.5] bg-neutral-950 border-[4.5px] border-neutral-900 rounded-[32px] shadow-3xl overflow-hidden hidden md:block border-solid z-20">
              <div className="absolute top-2.5 left-1/2 -translate-x-1/2 w-16 h-3.5 bg-black rounded-full z-30 flex items-center justify-center">
                <div className="w-1.5 h-1.5 rounded-full bg-neutral-800" />
              </div>
              <div className="w-full h-full bg-neutral-100 overflow-hidden relative">
                <img
                  src="/system-screenshot.png"
                  alt="Pedebook มุมมองมือถือ"
                  className="w-full h-full object-cover object-left select-none scale-[1.3] translate-y-6"
                />
              </div>
            </div>
      ...
      {/* ── SECTION: SEO & FEATURES SUMMARY (คุณสมบัติแพลตฟอร์ม) ── */}
      <section className="relative z-10 py-16 max-w-6xl mx-auto px-6 text-center space-y-12">
        <div className="space-y-4">
          <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-[#9a7257]">✨ คุณสมบัติหลักของแพลตฟอร์ม PEDEBOOK</h3>
          <h2 className="text-3xl font-medium tracking-tight text-[#17221c]">เปลี่ยนโบชัวร์กระดาษ ให้เปิดอ่านง่ายผ่านคิวอาร์โค้ด</h2>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-white/60 border border-[#e2dfd5] p-6 rounded-2xl text-left space-y-3 backdrop-blur-sm shadow-sm">
            <div className="w-10 h-10 rounded-xl bg-[#243129]/5 flex items-center justify-center text-lg">📖</div>
            <h4 className="font-bold text-sm text-[#17221c] font-sans">แชร์และแสดงผล 3D สมจริง</h4>
            <p className="text-xs text-[#6e746f] leading-relaxed font-sans">
              ผู้รับลิงก์สามารถใช้นิ้วปัดพลิกกระดาษ E-Book ได้ลื่นมือ มีเอฟเฟกต์พลิกกระดาษ 3D สมจริง พร้อมเสียงพลิกหน้ากระดาษ เพิ่มความน่าสนใจและความหรูหราให้สินค้า
            </p>
          </div>
          ...
          <div className="bg-white/60 border border-[#e2dfd5] p-6 rounded-2xl text-left space-y-3 backdrop-blur-sm shadow-sm">
            <div className="w-10 h-10 rounded-xl bg-[#243129]/5 flex items-center justify-center text-lg">🎨</div>
            <h4 className="font-bold text-sm text-[#17221c] font-sans">เฉดสีพื้นหลังปรับตามปกอัจฉริยะ</h4>
            <p className="text-xs text-[#6e746f] leading-relaxed font-sans">
              ระบบ AI วิเคราะห์หาเฉดสีจากรูปหน้าปกแค็ตตาล็อก PDF ของคุณ แล้วคำนวณสไลด์ไล่เฉดสีพื้นหลังทแยงมุมที่เข้ากันได้ดีกับเอกสารชิ้นนั้น ๆ ให้อัตโนมัติทันที
            </p>
          </div>

          {/* Card 3 */}
          <div className="bg-white/60 border border-[#e2dfd5] p-6 rounded-2xl text-left space-y-3 backdrop-blur-sm shadow-sm">
            <div className="w-10 h-10 rounded-xl bg-[#243129]/5 flex items-center justify-center text-lg">🖨️</div>
            <h4 className="font-bold text-sm text-[#17221c] font-sans">คิวอาร์โค้ดคมชัดสูง (Vector QR)</h4>
            <p className="text-xs text-[#6e746f] leading-relaxed font-sans">
              สร้างคิวอาร์โค้ดแบบรวดเร็วและดาวน์โหลดได้ เพื่อนำไปปริ้นต์แนบกับกล่องสินค้า ใบปลิว หรือป้ายแนะนำหน้าร้าน ให้ผู้มาติดต่อสแกนอ่านได้สะดวกสบาย
            </p>
          </div>
        </div>
      </section>
